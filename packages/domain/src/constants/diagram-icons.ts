...
export const DIAGRAM_ICONS = {
  alchemy: toDiagramIcon(siAlchemy),
  angular: {
  ...
  vitest: toDiagramIcon(siVitest),
  wrangler: { ...toDiagramIcon(siCloudflareworkers), title: "Wrangler" },
